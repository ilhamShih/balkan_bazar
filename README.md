# balkan_bazar
<li>Balkan Bazar это On-Line торговая площадка для неограниченного количества магазинов.</li>
<li>Цель программы объединить магазины в одном приложении по примеру AliExpress.</li>
<li>Создать все необходимые условия для того, чтобы клиенты вели свой бизнес комфортно.</li>
<li>Проект имеет расширение для синхронизации с программой-1С 8.1.</li>
<li>Программа имеет Административную часть и клиентскую.</li>
